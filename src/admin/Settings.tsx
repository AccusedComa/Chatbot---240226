        ...
        <div className="max-w-xl">
          ...
          <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
            ...
            <span className="ml-auto text-gray-400">
              Uso gratuito disponível (Free Tier). <a href="https://ai.google.dev/pricing" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Ver preços</a>
            </span>
          </p>
        </div>
      </div>
